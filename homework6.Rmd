...
### Now we sort the data by each month
...
#### Note that running the function will consume a lot of time

```{r, eval = FALSE}
print("the bloodiest month")
September_2017 <- this_month("2017-08-01")
print("Last month")
August_2018 <- this_month("2018-06-01")
print("Battles in the state of Aleppo")
Aleppo <- draw_map("Aleppo")
print("Battle places in all over Syria")
all <- draw_map(NA)
